...
vim.keymap.set('n', 'fg', require('telescope.builtin').git_files, { desc = 'Search [G]it [F]iles' })
...
vim.keymap.set('n', 'fv', require('telescope.builtin').live_grep, { desc = '[S]earch by [G]rep' })
vim.keymap.set('n', 'fd', require('telescope.builtin').diagnostics, { desc = '[S]earch [D]iagnostics' })
vim.keymap.set('n', 'fr', require('telescope.builtin').resume, { desc = '[S]earch [R]resume' })
...
keymap.set("n", "<leader>l", vim.cmd.UndotreeToggle)
